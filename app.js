...
function renderHeader() {
    ...
    sidebar.innerHTML = `
        <!-- ===== Mobile layout (< lg) ===== -->
        <div class="mobile-profile-layout lg:hidden">
            <span class="${avatarFull} mobile-profile-avatar">${avatarImg}</span>
            <div class="mobile-profile-copy">
                <div class="mobile-profile-heading">
                    <h1 class="mobile-profile-name">
                        <a href="index.html" class="hover:text-zinc-600 transition-colors">${displayName}</a>
                    </h1>
                    <p class="mobile-profile-role">Ph.D. Candidate @ XJTU</p>
                </div>
                <nav class="mobile-link-list" aria-label="Profile links">
                    ${mobileLinkRows}
                </nav>
            </div>
        </div>
